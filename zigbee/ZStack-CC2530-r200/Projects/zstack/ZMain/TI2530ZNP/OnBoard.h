/**************************************************************************************************
  Filename:       OnBoard.h
  Revised:        $Date: 2011-07-08 21:36:19 -0700 (Fri, 08 Jul 2011) $
  Revision:       $Revision: 26688 $
...
#define MAXMEMHEAP  3250
#else
#define MAXMEMHEAP  3420
#endif
#else
#if defined TC_LINKKEY_JOIN
#define MAXMEMHEAP  2620
#else
#define MAXMEMHEAP  2790
#endif
#endif
#endif
